    ...
    <View style={styles.cardContainer}>
      <Card containerStyle={styles.innerCardContainer}>
        ...
        <View style={styles.tabBar}>
          ...
          >
            <Text style={[styles.tabButtonText, selectedTab === 1 && styles.selectedTabText]}>Overview</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.tabButton,
          ...
          >
            <Text style={[styles.tabButtonText, selectedTab === 2 && styles.selectedTabText]}>Review</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.tabButton,
          ...
          >
            <Text style={[styles.tabButtonText, selectedTab === 3 && styles.selectedTabText]}>Playlist</Text>
          </TouchableOpacity>
        </View>
        {/* Course Information */}
