    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity
              onPress={(navigation) => navigateToNextPage(navigation)}>
              <View style={[styles.button]}>
                <Text style={[styles.buttonText]}>Year 2</Text>
              </View>
        </TouchableOpacity>
        <TouchableOpacity
              onPress={(navigation) => navigateToNextPage(navigation)}>
              <View style={styles.button}>
                <Text style={[styles.buttonText]}>Year 3</Text>
              </View>
        </TouchableOpacity>
        <TouchableOpacity
              onPress={(navigation) => navigateToNextPage(navigation)}>
              <View style={styles.button}>
                <Text style={[styles.buttonText]}>Year 4</Text>
              </View>
        </TouchableOpacity>
        <TouchableOpacity
              onPress={(navigation) => navigateToNextPage(navigation)}>
              <View style={styles.button}>
                <Text style={[styles.buttonText]}>Year 5</Text>
              </View>
        </TouchableOpacity>
        <TouchableOpacity
              onPress={(navigation) => navigateToNextPage(navigation)}>
              <View style={styles.button}>
                <Text style={[styles.buttonText]}>Year 6</Text>
              </View>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
