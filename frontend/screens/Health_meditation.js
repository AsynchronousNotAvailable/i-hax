...
const HealthMeditation = ({ navigation }) => {
    return (
        <ScrollView>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('HealthMusic',{ title: 'Mindful Living' })} style={{ flexDirection: 'row', padding: 10,  borderRadius: 15, marginLeft:20, alignItems:'center'}}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('HealthMusic',{ title: 'Manage negative emotions' })} style={{ flexDirection: 'row', padding: 10,  borderRadius: 15, marginLeft:20, alignItems:'center'}}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('HealthMusic',{ title: 'Breathing exercise'})} style={{ flexDirection: 'row', padding: 10,  borderRadius: 15, marginLeft:20, alignItems:'center'}}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('HealthMusic',{ title: 'Open Awareness'})} style={{ flexDirection: 'row', padding: 10,  borderRadius: 15, marginLeft:20, alignItems:'center'}}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('HealthMusic',{ title: 'Body without stress'})} style={{ flexDirection: 'row', padding: 10,  borderRadius: 15, marginLeft:20, alignItems:'center'}}>
